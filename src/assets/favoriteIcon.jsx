...
function FavoriteIcon({ favoriteCoin = false, handleClick }) {
    return (
        <svg onClick={handleClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
            width="16px" height="16px" className={`${favoriteCoin ? 'favorite-star-icon' : null} star-icon`}><polygon
